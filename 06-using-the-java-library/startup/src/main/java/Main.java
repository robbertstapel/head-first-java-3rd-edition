import simplestartup.game.UserList;
...
//    newSimpleStartup.guessOnce(3);
    ...
    UserList myStartup = new UserList();

    myStartup.users.add(0, "John");
    myStartup.users.add(1, "Rob");

    System.out.println(myStartup.users);
